...
<body>
  ...
  <section class="track_section layout_padding">
    <div class="track_bg_box">
      <img src="{{url('website/images/track-bg.jpg')}}" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="owl-carousel">
            <div class="item">
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    <img src="{{url('website/images/client-1.png')}}" alt="" class="img-1">
                  </div>
                  <div class="name">
                    <h6>
                      Adipiscing
            ...
            <div class="item">
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    <img src="{{url('website/images/client-2.png')}}" alt="" class="img-1">
                  </div>
                  <div class="name">
                    <h6>
                      Adipiscing
